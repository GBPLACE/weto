...
@section('title', 'WTEO | Edit Property Details')
@section('subheader')
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="weto-edit-info">
                        ...
                        <form action="{{route('submitEditedProperty')}}" method="post" id="editPropertyForm" enctype="multipart/form-data">
...
{{--                                        <option @if($property['type']=='Hotel') selected @endif value="Hotel">Hotel</option>--}}

{{--                                        <option @if($property['type']=='Hostel') selected @endif value="Hostel">Hostel</option>--}}

{{--                                        <option @if($property['type']=='Loft') selected @endif value="Loft">Loft</option>--}}

{{--                                        <option @if($property['type']=='Other') selected @endif value="Other">Other</option>--}}
                                ...
                                <li>
                                    ...
                                    <select name="bedroom" id="" class="form-control">
                                        ...
                                        <option @if($property['bedroom']=='6') selected @endif value="7">7</option>
                                    ...
                                    <ul>
                                        ...
                                        <li id="old_main_photo">
                                            ...
                                            @if(!is_null($property['property_main_photo']))
                                                ...
                                                <img src="{{asset('propertyUploads/'.$property['property_main_photo']['main_photo'])}}">
                                ...
                                <li class="full">
                                    ...
                                    <ul id="append_photo">
                                        ...
                                        @foreach($property['property_photo_order'] as $photo)
                                            ...
                                            <li class="width3 other_image_{{$photo['id']}}">
                                ...
                                <input type="hidden" name="draft" value="{{$property['draft']}}">

                                <li><input type="submit" class="submit2" value="Update"></li>
                ...
                <div class="col-md-12" style="margin-bottom: 10%;">
                    ...
                    <div class="availability-table">
                        ...
                        <table id="sort_photos">
                            ...
                            @if(count($property['property_photo_order']))
                            @foreach($property['property_photo_order'] as $key => $photo)

                                <tr class="row1 other_image_{{ $photo['id'] }}" data-id="{{ $photo['id'] }}">
                                    <td class="pl-3"><i class="fa fa-sort"></i></td>
                                    <td>{{ ++$key }}</td>
                                    <td><img src="{{asset('propertyUploads/'.$photo['other_photos'])}}" style="width: 100px;"></td>
                                </tr>

                            @endforeach
                            @else
                                <tr>
                                    <td colspan="3">No property image found.</td>
                                </tr>
                            @endif
                            </tbody>
                        </table>
                        ...
                        <button style="background: #00a99d;" class="btn btn-success" onClick="history.go(0);">Refresh</button>
                    </div>
