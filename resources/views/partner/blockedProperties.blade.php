...
@section('title', 'WTEO | Blocked Properties')
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h1>Blocked Properties</h1>

                </div>

                <div class="col-md-12 text-center">

                    <b>These properties are blocked by admin and are no longer available for users on website. Contact to admin for more details.</b>
                ...
                $('#example-2').pagination({
                    ...
                    ajax: function (options, refresh, $target) {
                        ...
                        $.ajax({
                            ...
                            url: '{{route('getPartnerBlockedProperties')}}',
                            ...
                            success: function (data) {
                                ...
                                $.each(data['property'], function (i, item) {
                                    ...
                                    html+='<div class="layer">'+
                                        ...
                                        '<a href="'+window.location.origin+'/partner/partnerPropertyDetails/'+property+'" style="background-image: url('+window.location.origin+'/propertyUploads/'+item.property_main_photo.main_photo+');">'+
                                        ...
                                        '<a href="'+window.location.origin+'/partner/partnerPropertyDetails/'+item.id+'" class="simple-btn pull-right">'+item.click.length+' Clicks</a>'+
                                ...
                                if (html == "") {
                                    ...
                                    html += '<div class="col-md-12 text-center">'+
                                        ...
                                        '<p>You have no blocked property.</p>'+
