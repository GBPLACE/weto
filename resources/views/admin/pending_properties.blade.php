...
@section('title', 'WETO | Pending Properties List')
...
@section('content')
    ...
    <div class="app-main__inner">
        ...
        <div class="card-header-tab card-header">
            ...
            <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="pe-7s-map mr-3 text-muted opacity-6" style="font-size: 35px; color: #2d7b8a !important;"> </i>Pending Properties</div>
        ...
        $( document ).ready(function() {
                ...
                $('#example-2').pagination({
                    ...
                    ajax: function (options, refresh, $target) {
                        ...
                        $.ajax({
                            ...
                            url: '{{route('getPendingPropertyListForAdmin')}}',
                            ...
                            success: function (data) {
                                ...
                                $.each(data['property'], function (i, item) {
                                    ...
                                    html    +='</a>'+
                                        ...
                                        '<a href="javascript:void(0)" class="fa fa-close reject" style="color: white;" data-id="'+item.id+'" title="Reject Property"></a>'+
            ...
            $(document).on('click', '.reject', function () {
                ...
                $.confirm({
                    ...
                    content: 'Are you sure you want to reject this property?',
